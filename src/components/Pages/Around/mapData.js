...
export const mapData = [
    ...
    {
        value: 2, type:  'visit', name: 'Agde', bikeAccess: false, icon: 'city' , gps: [43.307782, 3.476832], zoom: 11, center: [43.381782, 3.540774],
    ...
    {
        value: 4, type:  'visit', name: 'Bouzigues', bikeAccess: true, icon: 'city', gps: [43.449256, 3.654225], zoom: 14, center: [43.441344, 3.629912],
    ...
    {
        value: 5, type:  'visit', name: 'Pézenas', bikeAccess: false, icon: 'city', gps: [43.461322, 3.422846], zoom: 12, center: [43.453772, 3.513915],
    ...
    {
        value: 6, type:  'visit', name: 'Sète', bikeAccess: true, icon: 'city', gps: [43.407170, 3.700381], zoom: 13, center: [43.422235, 3.657855],
    ...
    {
        value: 7, type:  'visit', name: 'Lac du Salagou', bikeAccess: false, icon: 'water', gps: [43.656727, 3.372111], zoom: 11, center: [43.551814, 3.478541],
        description: 'Randonner sur des roches rouges pour finir par se baigner dans les rivière attenante ou dans le lac.'
    },
    {
        value: 8, type:  'visit', name: 'St Guilhem du désert', bikeAccess: false, icon: 'museum', gps: [43.734103, 3.548785], zoom: 10, center: [43.580546, 3.568560],
    ...
    {
        value: 0, type:  'eat', name: 'Loupian : Les Jardins du Pélican', bikeAccess: true, icon: 'grocery' , gps: [43.448746, 3.611701], zoom: 15, center: [43.442069, 3.609911],
        description: 'Vend sa production locale de fruit et légumes de saison'
    },
    {
        value: 1, type:  'eat', name: 'Mèze : Le Grazié', bikeAccess: true, icon: 'restaurant', gps: [43.423588, 3.607123], zoom: 15, center: [43.428718, 3.605153],
        description: 'Spécialité Italienne sur le port de Mèze.'
    },
    {
        value: 2, type:  'eat', name: 'Mèze : Le Bistro Del Mar', bikeAccess: true, icon: 'restaurant', gps: [43.423665, 3.607125], zoom: 15, center: [43.428734, 3.605625],
        description: 'Restaurant de viande et poisson sur le port de Mèze.'
    },
    {
        value: 3, type:  'eat', name: 'Mèze : Glace des Sables', bikeAccess: true, icon: 'icecream', gps: [43.422828, 3.607041], zoom: 15, center: [43.428641, 3.604981],
        description: 'Glacier artisanal sur le bord de l’étang à Mèze.'
    },
    {
        value: 4, type:  'eat', name: 'Mèze : Le ZEST, Atelier and Co, l’Ambre de thau, le Mas Soulas', bikeAccess: true, icon: 'restaurant', gps: [43.436436, 3.624045], zoom: 15, center: [43.434856, 3.615574],
    ...
    {
        value: 5, type:  'eat', name: 'Mèze : Marché aux fruits et légumes', bikeAccess: true, icon: 'grocery', gps: [43.426260, 3.607045], zoom: 15, center: [43.430667, 3.606961],
        description:  'Jeudi et dimanche matin.'
    },


    {
        value: 0, type:  'hobbies', name: 'Mèze : Cinéma le Taurus', bikeAccess: true, icon: 'movie' , gps: [43.419850, 3.600699], zoom: 15, center: [43.427204, 3.603879],
        description: 'Une petite salle familiale qui vous permettra de vous échappé les jours de pluie. Juste à coté de l’étang.'
    },
    {
        value: 1, type:  'hobbies', name: 'Mèze : Marché aux puces', bikeAccess: true, icon: 'grocery', gps: [43.425434, 3.606742], zoom: 15, center: [43.430109, 3.606262],
        description: 'samedi matin'
    },
    {
        value: 2, type:  'hobbies', name: 'Marché de Pézenas', bikeAccess: false, icon: 'grocery', gps: [43.459930, 3.422472], zoom: 12, center: [43.454395, 3.516038],
        description: 'Le samedi toute la journée'
    },
    {
        value: 3, type:  'hobbies', name: 'Festival de Thau', bikeAccess: true, icon: 'festival', gps: [43.422140, 3.605184], zoom: 15, center: [43.428658, 3.605137],
    ...
    {
        value: 4, type:  'hobbies', name: 'Le tours de l’étang de Thau à vélo', bikeAccess: true, icon: 'water', gps: [43.395286, 3.608610], zoom: 12, center: [43.395286, 3.608610],
